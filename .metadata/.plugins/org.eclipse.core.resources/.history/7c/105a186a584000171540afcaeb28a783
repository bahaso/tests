...
public class BoxMatchListen extends ExercisePage{
	
	public BoxMatchListen(AndroidDriver driver){
		this.driver = driver;
	}
	
	public ArrayList<WebElement> getDraggable(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/buttonBoxMatchListenChoiceItemFront");
	}
