...
import bahaso.testing.androidElement.PictureMultipleChoice;
import bahaso.testing.androidElement.SplashScreen;
import bahaso.testing.general.mobileGeneral;

public class PictureMultipleChoice_test extends mobileGeneral{
	SplashScreen splashScreen;
	Home home;
	PictureMultipleChoice pictureMultipleChoice;
	ArrayList<String> answers = new ArrayList<String>();
	
	@BeforeClass
	public void beforeclass(){
		answers.add("His name is John.");
	}
	...
	public void test1(){
		try {
			pictureMultipleChoice.answerRight(answers);
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void test2(){
		try {
			pictureMultipleChoice.answerWrong(answers);
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
