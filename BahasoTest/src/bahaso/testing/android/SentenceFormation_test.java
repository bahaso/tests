...
import bahaso.testing.androidElement.SentenceFormation;
import bahaso.testing.androidElement.SplashScreen;
import bahaso.testing.general.mobileGeneral;

public class SentenceFormation_test extends mobileGeneral{
	...
	public void beforeclass(){
		answers.add("Their names");
		answers.add("are Vince");
		answers.add("and Derek");
	}
	...
	public void test1(){
		try {
			sentenceFormation.answerRight(answers);
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void test2(){
		try {
			sentenceFormation.answerWrong(answers);
			Thread.sleep(3000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
