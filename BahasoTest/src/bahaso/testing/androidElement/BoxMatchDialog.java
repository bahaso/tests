...
public class BoxMatchDialog extends ExercisePage{
	
	public BoxMatchDialog(AndroidDriver driver){
		this.driver = driver;
	}
	
	public ArrayList<WebElement> getDraggable(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/buttonBoxMatchDialogChoiceItemFront");
	}
