...
public class BoxMatchListPicture extends ExercisePage{
	
	public BoxMatchListPicture(AndroidDriver driver){
		this.driver = driver;
	}
	
	public ArrayList<WebElement> getLayout(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/layoutCaseBoxMatchListPictureItem");
	}
	
	public ArrayList<WebElement> getDraggable(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/buttonBoxMatchListPictureChoiceItemFront");
	}
