...
public class BoxMatchPicture extends ExercisePage{
	
	public BoxMatchPicture(AndroidDriver driver){
		this.driver = driver;
	}
	public ArrayList<WebElement> getDraggable(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/buttonBoxMatchPictureChoiceItemFront");
	}
