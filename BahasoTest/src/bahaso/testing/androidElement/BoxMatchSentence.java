...
public class BoxMatchSentence extends ExercisePage{
	
	public BoxMatchSentence(AndroidDriver driver){
		this.driver = driver;
	}
	public ArrayList<WebElement> getDraggable(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/buttonBoxMatchSentenceChoiceItemFront");
	}
