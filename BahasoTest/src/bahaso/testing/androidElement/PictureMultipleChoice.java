...
public class PictureMultipleChoice extends ExercisePage{
	
	public PictureMultipleChoice(AndroidDriver driver){
		this.driver = driver;
	}
	public ArrayList<WebElement> getBoxAnswer(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/textViewPictureMultipleChoiceChoiceItem");
	}
