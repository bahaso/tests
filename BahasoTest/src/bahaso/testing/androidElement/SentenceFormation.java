...
public class SentenceFormation extends ExercisePage{
	
	public SentenceFormation(AndroidDriver driver){
		this.driver = driver;
	}
	public ArrayList<WebElement> getDraggable(){
		return (ArrayList<WebElement>) driver.findElementsById("com.bahaso:id/buttonSentenceFormationChoiceItemFront");
	}
