...
public class BoxMatchSentence extends ExcercisePage implements answerLesson{
	...
	public BoxMatchSentence(WebDriver driver){
		this.driver = driver;
	...
	public Object getAnswerData(Document data) {
		ArrayList<Document> ans = (ArrayList<Document>) data.get("parts");
		ArrayList<String> answer = new ArrayList<String>();
		for(int i=0;i<ans.size();i++){
			answer.add((String) ans.get(i).get("first"));
		}
		return answer;
	}
