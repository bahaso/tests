...
public class Comprehension extends ExcercisePage implements answerLesson{
	public ArrayList<WebElement> allChoices = new ArrayList<WebElement>();
	public WebElement choice;
	
	public Comprehension(WebDriver driver){
		this.driver = driver;
	}
	
	public ArrayList<WebElement> getAllAnswer(){
		return (ArrayList<WebElement>) driver.findElements(By.xpath("//input[@name='choice']"));
	}
